...
export const SCREWS: ScrewSpec[] = [
  { id: "pocket_1_1_4", label: 'Pocket screws 1-1/4"', lengthIn: 1.25, use: "Pocket holes into 3/4 stock", pricePerEa: 0.10 },
  { id: "pocket_2_1_2", label: 'Pocket screws 2-1/2"', lengthIn: 2.5,  use: "Pocket holes into 1-1/2 stock (aprons → legs)", pricePerEa: 0.12 },
  { id: "wood_1_1_4",   label: 'Wood screws #8 x 1-1/4"', lengthIn: 1.25, use: "Top/shelf to apron, pegboard mount", pricePerEa: 0.06 },
  { id: "wood_2",       label: 'Wood screws #8 x 2"',     lengthIn: 2,    use: "Top doubler, general assembly", pricePerEa: 0.08 },
  { id: "wood_2_1_2",   label: 'Wood screws #10 x 2-1/2"', lengthIn: 2.5, use: "Apron-to-leg (face screw alternative)", pricePerEa: 0.10 },
  { id: "wood_3",       label: 'Wood screws #10 x 3"',    lengthIn: 3,    use: "Heavy connections through 2x stock", pricePerEa: 0.12 },
  { id: "lag_3_8x4",    label: 'Lag bolts 3/8" x 4"',     lengthIn: 4,    use: "Heavy-duty apron-to-leg lag joints", pricePerEa: 0.85 },
  { id: "caster_screw", label: "Caster mount #12 x 1-1/2\"", lengthIn: 1.5, use: "Fasten caster plates to bottom of legs", pricePerEa: 0.10 },
];
...
// Consumables priced per unit
export const CONSUMABLES = {
  wood_glue_oz: { label: "Wood glue (Titebond II)", unit: "fl oz", pricePerUnit: 0.45 },
  finish_oz:    { label: "Polyurethane finish",     unit: "fl oz", pricePerUnit: 0.35 },
  sandpaper:    { label: "Sandpaper sheet",         unit: "sheet", pricePerUnit: 1.00 },
  caster:       { label: 'Locking caster 3" plate', unit: "ea",    pricePerUnit: 8.00 },
  edge_band_ft: { label: 'Iron-on edge banding 3/4"', unit: "ft",  pricePerUnit: 0.30 },
} as const;
